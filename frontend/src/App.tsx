...
const VoiceChat = lazy(() => import('./components/VoiceChat/VoiceChat'));
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
                        ...
                        <Container maxWidth="xl">
                            <Toolbar disableGutters sx={{ justifyContent: 'space-between', height: 80 }}>
                                ...
                                <Box component={RouterLink} to="/" sx={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
                                    <img src={logo} alt="Dr. B.C. Roy Society Engineering" style={{ height: 50 }} />
                                </Box>
                    ...
                    <Box component="footer" sx={{ py: 3, textAlign: 'center', color: '#666', bgcolor: '#f3f4f6', borderTop: '1px solid #e0e0e0' }}>
                        <Typography variant="body2">
                            © 2025 DR. B.C. Roy Society Engineering. All rights reserved.
                        </Typography>
                    </Box>
                </Box>
            </Router>
